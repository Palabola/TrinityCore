...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_GUILD_BANK_DEPOSIT_ITEM,                            STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankDepositItem);
    DEFINE_HANDLER(CMSG_GUILD_BANK_DEPOSIT_ITEM_SWAP,                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankDepositItem);
    DEFINE_HANDLER(CMSG_GUILD_BANK_DEPOSIT_ITEM_STACK_NEW,                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankDepositItem);
    DEFINE_HANDLER(CMSG_GUILD_BANK_DEPOSIT_ITEM_STACK_ADD,                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankDepositItem);
    ...
    DEFINE_HANDLER(CMSG_GUILD_BANK_MOVE_ITEM,                               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankSwapItems);
    DEFINE_HANDLER(CMSG_GUILD_BANK_STACK_ITEMS,                             STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankSwapItems);
    DEFINE_HANDLER(CMSG_GUILD_BANK_STACK_ITEMS_2,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankSwapItems);
    ...
    DEFINE_HANDLER(CMSG_GUILD_BANK_WITHDRAW_ITEM,                           STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankWithdrawItem);
    DEFINE_HANDLER(CMSG_GUILD_BANK_WITHDRAW_ITEM_AUTO,                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankWithdrawItemAuto);
    DEFINE_HANDLER(CMSG_GUILD_BANK_WITHDRAW_ITEM_STACK_ADD,                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankWithdrawItem);
    DEFINE_HANDLER(CMSG_GUILD_BANK_WITHDRAW_ITEM_STACK_NEW,                 STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildBankWithdrawItem);
