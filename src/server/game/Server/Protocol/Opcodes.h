...
enum OpcodeClient : uint16
{
    ...
    CMSG_GUILD_BANK_DEPOSIT_ITEM                      = 0x34B7,
    CMSG_GUILD_BANK_DEPOSIT_ITEM_SWAP                 = 0x34B9,
    CMSG_GUILD_BANK_DEPOSIT_ITEM_STACK_NEW            = 0x34BD,
    CMSG_GUILD_BANK_DEPOSIT_ITEM_STACK_ADD            = 0x34BC,
    ...
    CMSG_GUILD_BANK_MOVE_ITEM                         = 0x34BB,
    CMSG_GUILD_BANK_STACK_ITEMS                       = 0x34C1,
    CMSG_GUILD_BANK_STACK_ITEMS_2                     = 0x34C2,
    CMSG_GUILD_BANK_TEXT_QUERY                        = 0x3087,
    CMSG_GUILD_BANK_UPDATE_TAB                        = 0x34C5,
    CMSG_GUILD_BANK_WITHDRAW_ITEM                     = 0x34B8,
    CMSG_GUILD_BANK_WITHDRAW_ITEM_STACK_ADD           = 0x34BE,
    CMSG_GUILD_BANK_WITHDRAW_ITEM_STACK_NEW           = 0x34BF,
    CMSG_GUILD_BANK_WITHDRAW_ITEM_AUTO                = 0x34C0,
